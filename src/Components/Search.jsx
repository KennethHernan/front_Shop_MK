...
function Search({ onModalCart, onAñadirCart }) {
  ...
  return (
    <div
      className={`
        w-full sticky top-0 left-0 bg-[#ffffff] z-40 transition-all duration-200 ease-linear overflow-hidden
        ${search ? "h-[100vh] py-2" : "h-[0px]"}
        `}
    >
      ...
      <section
        ...
        ${
          itemSearch.length > 0 || resultado.length > 0 ? "h-auto py-3" : "h-0"
        }`}
      >
