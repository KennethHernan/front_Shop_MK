...
const Footer = ({ navbar }) => {
  return (
    <>
      <div className=" flex justify-between border-[0px] border-t-[0.5px] border-[#ebebeb] pt-8 mx-10 mb-[200px] font-light">
          ...
          <section>
            ...
            <div className="grid grid-cols-4 gap-2">
              <button className="w-[50px] flex justify-start items-center">
                <img src={icon_fb} className="w-[30px] transition-all duration-500 hover:size-8" />
              </button>
              
              <button className="w-[50px] flex justify-start items-center">
                <img src={icon_ig} className="w-[30px] transition-all duration-500 hover:size-8" />
              </button>
              
              <button className="w-[50px] flex justify-start items-center">
                <img src={icon_wsp} className="w-[30px] transition-all duration-500 hover:size-8" />
              </button>
              
              <button className="w-[50px] flex justify-start items-center">
                <img src={icon_tiktok} className="w-[30px] transition-all duration-500 hover:size-8" />
              </button>
            </div>
          </section>
        </section>
